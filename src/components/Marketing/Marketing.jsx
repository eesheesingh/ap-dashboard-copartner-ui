  ...
  return (
    <div className="xl:p-4 md:p-4 sm:ml-[8rem] text-white">
      <div className="p-4 px-10 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        ...
        {/* Banners */}
        <div className='py-3'>
          <h2 className="text-left md:text-[27px] xl:text-[40px] font-semibold pb-3">Banners</h2>
          <BannerSlider />
        </div>

        {/* Videos */}
        <div className='py-3'>
          <h2 className="text-left md:text-[27px] xl:text-[40px] font-semibold pb-3">Videos</h2>
          <BannerSliderVideo />
        </div>
