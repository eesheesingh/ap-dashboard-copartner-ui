      ...
      <div className="bg-[#2E374B] p-4 rounded-[20px] shadow-lg relative w-[400px]">
        ...
        <div className='grid grid-cols-2 gap-4'>
          <div className="relative col-span-2">
            <input type="number" id="UpiID" required className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-[15px] border-1 border-[1px] appearance-none dark:text-white dark:border-gray-600 dark:focus:border-[#ffffff46] focus:outline-none focus:ring-0 focus:border-[#ffffff41] peer" placeholder=" " value={UpiDetails.UpiID} onChange={handleChange} />
