...
const Dashboard = () => {
  ...
  return (
    <div className="xl:p-4 md:p-4 sm:ml-[8rem] text-white">
      <div className="md:p-4 p-1 border-gray-200 border-dashed rounded-lg dark:border-gray-700 md:mt-14 mt-[90px]">
        <div className="text-white text-center">
          {/* First Section */}
          <div className="flex md:flex-row flex-col justify-between mt-2 md:flex-nowrap flex-wrap">
